...
<div style="display:block;text-align:center">
  <a aria-describedby="Link zu Ilias" href="./ilias.md" style="float:left;padding:20px;">Ilias</a>
  <a aria-describedby="Link zu Moodle" href="./moodle.md" style="float:left;padding:20px;">Moodle</a>
  <a aria-describedby="Link zu Stud.IP Courseware" href="./courseware.md" style="float:left;padding:20px;">Stud.IP Courseware</a>
</div>
