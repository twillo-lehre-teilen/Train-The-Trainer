...
<div>
  ...
  <div class="panel">
    <p>
      <figure style="align:middle;">
        <a href="images/le_node2.svg" target="_blank"><img src="images/le_node.svg" alt="Abbildung: Screenshot LiaEdit Editor 2" title="Abbildung: Screenshot LiaEdit Editor 2"/></a>
        <figcaption style="text-align:center;font-size:14px;">Abbildung: Screenshot LiaEdit Editor 2</figcaption>
      </figure>
      <br>
      <figure style="align:middle;">
  ...
  <div class="panel">
    <p>
      Delete. Mention it in other chapter.
    </p>
  </div>
